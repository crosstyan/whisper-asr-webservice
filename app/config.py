...
class CONFIG:
    ...
    #   'bfloat16' - 16-bit bfloat16 precision (faster inference without sacrificing precision, but only natively supported by some GPUs)
    ...
    if MODEL_QUANTIZATION not in {"float32", "float16", "int8", "bfloat16"}:
        raise ValueError("Invalid MODEL_QUANTIZATION. Choose 'float32', 'float16', `bfloat16`, or 'int8'.")
